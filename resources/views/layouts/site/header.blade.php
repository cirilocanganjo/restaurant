...
<head>
    ...
    <!-- BOOTSTRAP CSS -->
    <link rel="stylesheet" href="{{ asset('/site/libs/bootstrap/css/bootstrap.min.css') }} " media="all" />

    <!-- FONT AWESOME -->
    <link rel="stylesheet" href="{{ asset('/site/libs/fontawesome/css/font-awesome.min.css') }} " media="all" />

    <!-- FONT AWESOME -->
    <link rel="stylesheet" href="{{ asset('/site/libs/maginificpopup/magnific-popup.css') }} " media="all" />

    <!-- OWL CAROUSEL CSS -->
    <link rel="stylesheet" href=" {{ asset('/site/libs/owlcarousel/owl.carousel.min.css') }}" media="all" />
    <link rel="stylesheet" href="{{ asset('/site/libs/owlcarousel/owl.theme.default.min.css') }} " media="all" />
    ...
    <link rel="stylesheet" href="{{ asset('/site/libs/animate/animate.css') }} " media="all" />


    <!-- bootstrap datepicker -->
    <link rel="stylesheet" href="{{ asset('/site/libs/datepicker/bootstrap-datetimepicker.min.css') }}"
        media="all" />

    <!-- MASTER  STYLESHEET  -->
    <link id="lgx-master-style" rel="stylesheet" href="{{ asset('/site/css/style-default.min.css') }} "
        media="all" />
