                    ...
                    <ul class="navbar-nav header-right">
                                    ...
                                    <div class="card-body px-0">
                                        ...
                                        <div class="dlab-scroll px-3 mt-3 height300">
                                            <ul class="d-flex align-items-center mb-3">
                                                <li>
                                                    <img src="/dashboard/images/avatar/1.jpg" class="avatar avatar-sm"
                                                        alt="">
                                            ...
                                            <ul class="d-flex align-items-center mb-3">
                                                <li>
                                                    <img src="/dashboard/images/avatar/2.jpg" class="avatar avatar-sm"
                                                        alt="">
                                            ...
                                            <ul class="d-flex align-items-center mb-3">
                                                <li>
                                                    <img src="/dashboard/images/avatar/4.jpg" class="avatar avatar-sm"
                                                        alt="">
                                                    <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                                            ...
                                            <ul class="d-flex align-items-center mb-3">
                                                <li>
                                                    <img src="/dashboard/images/avatar/3.jpg" class="avatar avatar-sm"
                                                        alt="">
                                                    <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                                            ...
                                            <div class="timeline-panel">
                                                <div class="media me-2">
                                                    <img alt="image" width="50"
                                                        src="/dashboard/images/avatar/1.jpg">
                                                </div>
                        ...
                        <li class="nav-item dropdown notification_dropdown">
                            <a class="nav-link me-0 " href="javascript:void(0);" data-bs-toggle="dropdown">
                                <svg width="20" class="setting-svg" height="20" viewBox="0 0 32 32"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="dropdown header-profile2">
                                <a class="nav-link ms-0" href="javascript:void(0);" role="button"
                                    ...
                                    <div class="header-info2 d-flex align-items-center">
                                        ...
                                        <img src="/dashboard/images/user.jpg" alt="">
                                    </div>
                                </a>
                                    ...
                                    <div class="card mb-0">
                                        <div class="card-header p-3">
                                            <ul class="d-flex align-items-center">
                                                <li>
                                                    <img src="/dashboard/images/user.jpg" class="ms-0"
                                                        alt="">
                                                </li>
                                                <li class="ms-2">
                                        ...
                                        <div class="card-footer text-center p-3">
                                            <a href="{{ route('logout') }}"
                                                ...
                                                <span class="ms-2 text-primary">Terminar Sessão </span>
                                            </a>
            ...
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ route('food.create') }}">Cadastar pratos</a></li>
                        <li><a href="{{ route('food.index') }}">Listar pratos </a></li>
                    </ul>
                ...
                <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                        ...
                        <span class="nav-text">Estatística</span>
                    </a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ route('register') }}">Cadastar</a></li>
