...
<!-- FAVICONS ICON -->
	...
	<link href="/dashboard/vendor/wow-master/css/libs/animate.css" rel="stylesheet">
	<link href="/dashboard/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link rel="stylesheet" href="/dashboard/vendor/bootstrap-select-country/css/bootstrap-select-country.min.css">
	<link rel="stylesheet" href="/dashboard/vendor/jquery-nice-select/css/nice-select.css">
	<link href="/dashboard/vendor/datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">

	 <link href="/dashboard/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
	<!--swiper-slider-->
	<link rel="stylesheet" href="/dashboard/vendor/swiper/css/swiper-bundle.min.css">
	<!-- Style css -->
