        ...
        <div class="login-aside text-center  d-flex flex-column flex-row-auto">
            <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                <div class="text-center mb-lg-4 mb-2 pt-5 logo">
                    <img src="/dashboard/images/logo-white.png" alt="">
                </div>
                <h3 class="mb-2 text-white">Bem Vindo!</h3>
                <p class="mb-4">User Experience & Interface Design <br>Strategy SaaS Solutions</p>
            </div>
            <div class="aside-image position-relative"
                style="background-image:url(/dashboard/images/background/pic-2.png);">
                <img class="img1 move-1" src="/dashboard/images/background/pic3.png" alt="">
                <img class="img2 move-2" src="/dashboard/images/background/pic4.png" alt="">
                <img class="img3 move-3" src="/dashboard/images/background/pic5.png" alt="">
                        ...
                        <div class="col-xl-12 tab-content">
                            ...
                            <div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="sepertor">
                                        <span class="d-block mb-4 fs-13">Com Email</span>
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 May 2023 12:01:45 GMT -->
